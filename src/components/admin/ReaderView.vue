...
import { DeleteFilled, SaveTwoTone } from '@ant-design/icons-vue'
...
<template>
  ...
  <a-spin :spinning="loading">
    <a-table :data-source="readerData" :columns="columns" :pagination="false" :scroll="{ y: '800px' }"
        ...
        <template v-if="column.key === 'action'">
          <div style="display: flex;">
            ...
            <a-popconfirm
              ...
              <a-button type="dashed" :size="large" danger :icon="h(DeleteFilled)">删除
              </a-button>
            </a-popconfirm>
